...
Single backend:
    python 04_audit.py --model ollamads
...
def main():
    ...
    if args.models:
        keys = [k for k in args.models if k in ("ollamads", "cohere", "ollama")]
        ...
        raise SystemExit("pass --model ollamads  or  --models ollamads cohere ollama")

    keep_cols = [c for c in ("audit_stratum", "review_id", "paper_id", "title",
                             "gold_label", "flagged_by", "tool_decision",
                             "reason", "decision_ollamads", "decision_cohere",
                             "decision_ollama", "reason_ollamads", "reason_cohere",
